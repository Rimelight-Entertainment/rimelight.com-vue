  ...
  <div class="space-y-16">
    <section class="space-y-6">
      ...
      <h1 class="text-5xl font-black uppercase tracking-tighter text-white leading-none">Welcome to <br /> <span
          class="text-grand-tale-secondary-500">Grand Tale</span></h1>
      <p class="text-xl text-grand-tale-secondary-100/60 font-light max-w-2xl leading-relaxed">
        Your comprehensive guide to understanding the world, mechanics, and lore of Grand Tale. Start here if you're new
        to the game.
      </p>
    </section>
    ...
    <section class="space-y-8">
      <h2 class="text-2xl font-bold text-white uppercase tracking-tight flex items-center gap-3">
        <UIcon name="i-lucide-book-open" class="text-grand-tale-secondary-500" />
        New Players
      </h2>
    ...
    <section class="space-y-8">
      <h2 class="text-2xl font-bold text-white uppercase tracking-tight flex items-center gap-3">
        <UIcon name="i-lucide-scroll-text" class="text-grand-tale-secondary-500" />
        Lore Seekers
      </h2>

      <div class="space-y-4">
        <p class="text-grand-tale-secondary-100/60 leading-relaxed">
          Dive into the chronology of the Cataclysm and the rise of the Nine Factions. The world of Grand Tale is rich
          with
      ...
      <UCard class="bg-grand-tale-primary-800/10 border-grand-tale-secondary-800/50">
        <div class="flex flex-col md:flex-row gap-8 items-center">
          <div class="p-4 bg-grand-tale-primary-500/20 rounded-none border border-grand-tale-secondary-500/30">
            <UIcon name="i-lucide-info" class="size-8 text-grand-tale-secondary-400" />
          </div>
          <div class="space-y-2">
            <h4 class="font-bold text-white uppercase">Alpha Notice</h4>
            <p class="text-sm text-grand-tale-secondary-100/40">
              Many articles are currently being drafted by the development team. If you encounter missing information or
              placeholder images, please report it via the Support portal.
            </p>
          </div>
        </div>
      </UCard>
