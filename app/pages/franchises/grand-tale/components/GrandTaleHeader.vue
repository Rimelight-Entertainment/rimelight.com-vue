...
<template>
  <RCHeader class="bg-grand-tale-primary-700 border-b border-grand-tale-secondary-400 shadow-lg" :contain="false">
    <template #left>
    ...
    <template #right>
      <div class="flex flex-row items-center gap-md">
        ...
        <UButton variant="solid" label="Play Now" class="bg-grand-tale-secondary-400 text-white hover:bg-grand-tale-secondary-600"/>
      </div>
    </template>
    ...
    <template #collapsed-right>
      <div class="flex items-center px-4 justify-end">
        <ClientOnly>
          <USlideover v-model:open="isSlideoverOpen" title="Grand Tale" :ui="{
