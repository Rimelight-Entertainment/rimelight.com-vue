      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p class="text-lg text-neutral-400 leading-relaxed mt-4">
            Founded by passionate gamers and developers, Rimelight Entertainment is dedicated to
            pushing the boundaries of what is possible in interactive media. We believe in the power
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <UCard class="bg-neutral-950/50 border-neutral-800">
            ...
            <p class="text-neutral-400">
              Everything we do starts and ends with the player experience. We listen, we learn, and
          ...
          <UCard class="bg-neutral-950/50 border-neutral-800">
            ...
            <p class="text-neutral-400">
              We are not afraid to take risks and explore new technologies to create unique and
          ...
          <UCard class="bg-neutral-950/50 border-neutral-800">
            ...
            <p class="text-neutral-400">
              Great games are built by great teams. We foster an environment of trust, respect, and
              open communication.
            </p>
          </UCard>
        </div>
