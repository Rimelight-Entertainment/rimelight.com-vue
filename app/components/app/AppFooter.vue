  ...
  <RCFooter :contain="false" class="bg-black z-50 border-t-2 border-primary-500">
    ...
    <template #right>
      <div class="flex flex-col gap-sm lg:items-end">
        ...
        <ClientOnly>
          <ULocaleSelect :locales="availableLocales" :model-value="locale" class="w-48 rounded-none" color="secondary"
      ...
      <div class="flex flex-col items-center gap-xs lg:items-end">
        <div class="flex flex-row gap-sm lg:items-end">
          <UButton class="text-white hover:text-primary-100" color="neutral" icon="mdi:instagram" size="xl"
                   to="https://www.instagram.com/rimelight.com" variant="ghost"/>
          <UButton class="text-white hover:text-primary-100" color="neutral" icon="ic:baseline-discord" size="xl"
                   to="https://discord.com/users/682049695173836979" variant="ghost"/>
          <UButton class="text-white hover:text-primary-100" color="neutral" icon="mdi:spotify" size="xl"
                   to="https://open.spotify.com/user/v5m4qoc9j35ccc6nbzqcookvj?si=d795f9bc1cb34222" variant="ghost"/>
          <UButton class="text-white hover:text-primary-100" color="neutral" icon="mdi:github" size="xl"
                   to="https://www.github.com/rimelight" variant="ghost"/>
          <UButton class="text-white hover:text-primary-100" color="neutral" icon="mdi:linkedin" size="xl"
                   to="https://www.linkedin.com/company/rimelight" variant="ghost"/>
        </div>
      </div>
    </template>
  </RCFooter>
