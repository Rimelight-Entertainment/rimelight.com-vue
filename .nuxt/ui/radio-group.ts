...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-commentary"
      }
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-ideation"
      }
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-source"
      }
    },
    {
      "color": "neutral" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-commentary/10 has-data-[state=checked]:border-commentary/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-ideation/10 has-data-[state=checked]:border-ideation/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "source" as typeof color[number],
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-source/10 has-data-[state=checked]:border-source/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "neutral" as typeof color[number],
