...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-commentary"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-ideation"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-source"
    },
    {
      "color": "primary" as typeof color[number],
      "highlight": true,
