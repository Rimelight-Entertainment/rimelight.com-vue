...
export default {
  ...
  "variants": {
    "color": {
      ...
      "commentary": {
        "link": "focus-visible:before:ring-commentary",
        "childLink": "focus-visible:before:ring-commentary"
      },
      "ideation": {
        "link": "focus-visible:before:ring-ideation",
        "childLink": "focus-visible:before:ring-ideation"
      },
      "source": {
        "link": "focus-visible:before:ring-source",
        "childLink": "focus-visible:before:ring-source"
      }
    },
    "highlightColor": {
      "primary": "",
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "active": true,
      "class": {
        "link": "text-commentary",
        "linkLeadingIcon": "text-commentary group-data-[state=open]:text-commentary"
      }
    },
    {
      ...
      "class": {
        "link": "text-ideation",
        "linkLeadingIcon": "text-ideation group-data-[state=open]:text-ideation"
      }
    },
    {
      ...
      "class": {
        "link": "text-source",
        "linkLeadingIcon": "text-source group-data-[state=open]:text-source"
      }
    },
    {
      "color": "neutral" as typeof color[number],
    ...
    {
      "highlightColor": "commentary" as typeof highlightColor[number],
      "highlight": true,
      "level": true,
      "active": true,
      "class": {
        "link": "after:bg-commentary"
      }
    },
    {
      "highlightColor": "ideation" as typeof highlightColor[number],
      "highlight": true,
      "level": true,
      "active": true,
      "class": {
        "link": "after:bg-ideation"
      }
    },
    {
      "highlightColor": "source" as typeof highlightColor[number],
      "highlight": true,
      "level": true,
      "active": true,
      "class": {
        "link": "after:bg-source"
      }
    },
    {
      "highlightColor": "neutral" as typeof highlightColor[number],
