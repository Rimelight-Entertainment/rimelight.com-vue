...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "pill" as typeof variant[number],
      "class": {
        "indicator": "bg-commentary",
        "trigger": "data-[state=active]:text-inverted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-commentary"
      }
    },
    {
      ...
      "variant": "pill" as typeof variant[number],
      "class": {
        "indicator": "bg-ideation",
        "trigger": "data-[state=active]:text-inverted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ideation"
      }
    },
    {
      ...
      "class": {
        "indicator": "bg-source",
        "trigger": "data-[state=active]:text-inverted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-source"
      }
    },
    {
      "color": "neutral" as typeof color[number],
    ...
    },
    {
      ...
      "class": {
        "indicator": "bg-commentary",
        "trigger": "data-[state=active]:text-commentary focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-commentary"
      }
    },
    {
      "color": "ideation" as typeof color[number],
      ...
      "class": {
        "indicator": "bg-ideation",
        "trigger": "data-[state=active]:text-ideation focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ideation"
      }
    },
    {
      "color": "source" as typeof color[number],
      ...
      "class": {
        "indicator": "bg-source",
        "trigger": "data-[state=active]:text-source focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-source"
      }
    },
    {
      "color": "neutral" as typeof color[number],
