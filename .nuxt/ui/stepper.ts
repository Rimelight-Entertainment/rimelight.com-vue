...
export default {
  ...
  "variants": {
    ...
    "color": {
      ...
      "commentary": {
        "trigger": "group-data-[state=completed]:bg-commentary group-data-[state=active]:bg-commentary focus-visible:outline-commentary",
        "separator": "group-data-[state=completed]:bg-commentary"
      },
      "ideation": {
        "trigger": "group-data-[state=completed]:bg-ideation group-data-[state=active]:bg-ideation focus-visible:outline-ideation",
        "separator": "group-data-[state=completed]:bg-ideation"
      },
      "source": {
        "trigger": "group-data-[state=completed]:bg-source group-data-[state=active]:bg-source focus-visible:outline-source",
