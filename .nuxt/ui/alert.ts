...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "solid" as typeof variant[number],
      "class": {
        "root": "bg-commentary text-inverted"
      }
    },
    {
      ...
      "variant": "solid" as typeof variant[number],
      "class": {
        "root": "bg-ideation text-inverted"
      }
    },
    {
    ...
    },
    {
      ...
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-commentary ring ring-inset ring-commentary/25"
      }
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-ideation ring ring-inset ring-ideation/25"
      }
    },
    {
      "color": "source" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-source ring ring-inset ring-source/25"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "soft" as typeof variant[number],
      "class": {
        "root": "bg-commentary/10 text-commentary"
      }
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "soft" as typeof variant[number],
      "class": {
        "root": "bg-ideation/10 text-ideation"
      }
    },
    {
      "color": "source" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-commentary/10 text-commentary ring ring-inset ring-commentary/25"
      }
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-ideation/10 text-ideation ring ring-inset ring-ideation/25"
      }
    },
    {
      "color": "source" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-source/10 text-source ring ring-inset ring-source/25"
      }
    },
    {
      "color": "neutral" as typeof color[number],
