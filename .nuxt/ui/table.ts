...
export default {
  ...
  "compoundVariants": [
    ...
    {
      "loading": true,
      "loadingColor": "commentary" as typeof loadingColor[number],
      "class": {
        "thead": "after:bg-commentary"
      }
    },
    {
      "loading": true,
      "loadingColor": "ideation" as typeof loadingColor[number],
      "class": {
        "thead": "after:bg-ideation"
      }
    },
    {
      "loading": true,
      "loadingColor": "source" as typeof loadingColor[number],
      "class": {
        "thead": "after:bg-source"
      }
    },
    {
      "loading": true,
