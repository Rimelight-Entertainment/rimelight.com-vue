...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "solid" as typeof variant[number],
      "class": "text-inverted bg-commentary"
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "solid" as typeof variant[number],
      "class": "text-inverted bg-ideation"
    },
    {
      "color": "source" as typeof color[number],
      "variant": "solid" as typeof variant[number],
      "class": "text-inverted bg-source"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "commentary" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": "ring ring-inset ring-commentary/50 text-commentary"
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": "ring ring-inset ring-ideation/50 text-ideation"
    },
    {
      "color": "source" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": "ring ring-inset ring-source/50 text-source"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "commentary" as typeof color[number],
      "variant": "soft" as typeof variant[number],
      "class": "text-commentary bg-commentary/10"
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "soft" as typeof variant[number],
      "class": "text-ideation bg-ideation/10"
    },
    {
      "color": "source" as typeof color[number],
      "variant": "soft" as typeof variant[number],
      "class": "text-source bg-source/10"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "commentary" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": "text-commentary ring ring-inset ring-commentary/25 bg-commentary/10"
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": "text-ideation ring ring-inset ring-ideation/25 bg-ideation/10"
    },
    {
      "color": "source" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": "text-source ring ring-inset ring-source/25 bg-source/10"
    },
    {
      "color": "neutral" as typeof color[number],
      "variant": "solid" as typeof variant[number],
