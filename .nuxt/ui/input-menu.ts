...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-commentary"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-ideation"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-source"
    },
    {
      "color": "neutral" as typeof color[number],
      "multiple": true,
    ...
    },
    {
      ...
      "class": "focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-commentary"
    },
    {
      "color": "ideation" as typeof color[number],
      "variant": [
      ...
      "class": "focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ideation"
    },
    {
      "color": "source" as typeof color[number],
      "variant": [
      ...
      "class": "focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-source"
    },
    {
      "color": "primary" as typeof color[number],
      "highlight": true,
    ...
    },
    {
      "color": "commentary" as typeof color[number],
      "highlight": true,
      "class": "ring ring-inset ring-commentary"
    },
    {
      "color": "ideation" as typeof color[number],
      "highlight": true,
      "class": "ring ring-inset ring-ideation"
    },
    {
      "color": "source" as typeof color[number],
      "highlight": true,
      "class": "ring ring-inset ring-source"
    },
    {
      "color": "neutral" as typeof color[number],
      "variant": [
