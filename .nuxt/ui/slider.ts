...
export default {
  ...
  "variants": {
    "color": {
      ...
      "commentary": {
        "range": "bg-commentary",
        "thumb": "ring-commentary focus-visible:outline-commentary/50"
      },
      "ideation": {
        "range": "bg-ideation",
        "thumb": "ring-ideation focus-visible:outline-ideation/50"
      },
      "source": {
        "range": "bg-source",
        "thumb": "ring-source focus-visible:outline-source/50"
      }
    },
    "size": {
      "xs": {
