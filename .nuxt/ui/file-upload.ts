...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "focus-visible:outline-commentary"
    },
    {
      "color": "ideation" as typeof color[number],
      "class": "focus-visible:outline-ideation"
    },
    {
      "color": "source" as typeof color[number],
      "class": "focus-visible:outline-source"
    },
    {
      "color": "primary" as typeof color[number],
      "highlight": true,
    ...
    },
    {
      "color": "commentary" as typeof color[number],
      "highlight": true,
      "class": "border-commentary"
    },
    {
      "color": "ideation" as typeof color[number],
      "highlight": true,
      "class": "border-ideation"
    },
    {
      "color": "source" as typeof color[number],
      "highlight": true,
