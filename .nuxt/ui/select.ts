...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "focus:ring-2 focus:ring-inset focus:ring-commentary"
    },
    {
      ...
      "class": "focus:ring-2 focus:ring-inset focus:ring-ideation"
    },
    {
      ...
      "class": "focus:ring-2 focus:ring-inset focus:ring-source"
    },
    {
      "color": "primary" as typeof color[number],
      "highlight": true,
