...
export default {
  ...
  "compoundVariants": [
    ...
    {
      "spotlightColor": "commentary" as typeof spotlightColor[number],
      "spotlight": true,
      "class": {
        "root": "[--spotlight-color:var(--ui-commentary)]"
      }
    },
    {
      "spotlightColor": "ideation" as typeof spotlightColor[number],
      "spotlight": true,
      "class": {
        "root": "[--spotlight-color:var(--ui-ideation)]"
      }
    },
    {
      "spotlightColor": "source" as typeof spotlightColor[number],
      "spotlight": true,
      "class": {
        "root": "[--spotlight-color:var(--ui-source)]"
      }
    },
    {
      "spotlightColor": "neutral" as typeof spotlightColor[number],
